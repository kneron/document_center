...
* **Attributes**
    ...
    * **KP_ERROR_DBG_CHECKPOINT_INSUFFICIENT_BUFFER_SIZE_49** : [`int`](https://docs.python.org/3/library/functions.html#int), default=49
    ...
    * **KP_FW_ERROR_INVALID_PRE_POST_PROCESS_CONFIG_139** : [`int`](https://docs.python.org/3/library/functions.html#int), default=139
