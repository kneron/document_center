...
- **Runtime Upload Firmware (USB Boot)**
    ...
    - The GUI or command line of **KneronDFUT** can be used for writing the loader firmware to flash memory and switch AI dongles to USB boot mode.
...
- **Firmware in Flash Memory (Flash Boot)**
    ...
    - This mode is using the **KDP2 firmware** stored in the flash memory of AI dongles.

    - Once the AI dongle is electrified, the firmware will be automatically activated.

    - The GUI or command line of **KneronDFUT** can be used for writing KDP2 firmware to flash memory and switch AI dongles to Flash boot mode.
