...
Note that the latest toolchain version v0.24.0. You can find the version of the toolchain in
`/workspace/version.txt` inside the docker. If you find your toolchain is earlier than v0.24.0, you may need to find the
