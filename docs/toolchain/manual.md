...
**This document is compatible with `kneron/toolchain:v0.18.1`.**
...
Note that this document is compatible with toolchain v0.18.1. You can find the version of the toolchain in
`/workspace/version.txt` inside the docker. If you find your toolchain is later than v0.18.1, you may need to find the
