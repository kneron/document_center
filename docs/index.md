...
2. Fill the anchor and class name information. Go to the folder path `/workspace/scripts/utils/yolo/kerasyolo3/model_data`, fill the anchor.txt and classes.txt based on the information of your model.
