...
Documents in **Customized API** explain the usage of create customized API in Software (Kneron PLUS) and the corresponding implementation in Firmware (KL520 and KL720):
