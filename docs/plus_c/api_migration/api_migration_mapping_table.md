...
| Inference Data Type | Kneron PLUS 1.x (kp\_inference.h)                         | Kneron PLUS 2 (kp\_inference.h)                           |
| ------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
...
| Inference Data Type | Kneron PLUS 1.x (kp\_inference.h)                         | Kneron PLUS 2 - Compat (legacy/kp\_inference\_v1.h)      |
| ------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
...
| Inference Data Type | Kneron PLUS 1.x (kp\_struct.h)                         | Kneron PLUS 2 (kp\_struct.h)                           |
| ------------------- | ------------------------------------------------------ | ------------------------------------------------------ |
...
| Inference Data Type | Kneron PLUS 1.x (kp\_struct.h)                         | Kneron PLUS 2 - Compat (legacy/kp\_struct\_v1.h)      |
| ------------------- | ------------------------------------------------------ | ------------------------------------------------------ |
